...
interface TallyReportLayoutProps {
  ...
  // Tally-style vertical action panel pinned to the right of the report body
  // (pass a shared <RightActionPanel/>). Spans the full height of the content
  // area, beside both the subtitle row and the scrollable children.
...
export function TallyReportLayout({
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-white select-none text-black font-sans text-[11px]">
      ...
      {/* Body row — report column (breadcrumb + subtitle + content) beside the
          optional Tally-style right action panel, which spans the full height. */}

...
interface InterestGroupLayoutProps {
  fromDate?: string;
  toDate?: string;
}
...
export default function InterestGroupLayout({
  ...
  React.useEffect(() => {
    ...
    Promise.all([
      ...
      rawList.forEach((g: any) => {
        nameMap.set(g.group_id, g.name);
  ...
  React.useEffect(() => {
    ...
    (window as any).api.report
      .groupInterest(cid, fyid, {
        group_id: groupId,
        from_date: fromDate || undefined,
        to_date: fyEnd || undefined,
      })
      .then((res: any) => {
        if (res?.success) {

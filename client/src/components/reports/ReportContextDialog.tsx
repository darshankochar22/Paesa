...
export function ReportContextDialog({ isOpen, onClose, config, onSave }: ReportContextDialogProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-md bg-white text-black border border-gray-200">
        <DialogHeader>
          <DialogTitle className="text-black font-bold">Configuration (F4)</DialogTitle>
        </DialogHeader>
        <div className="flex flex-col gap-4 py-4 text-xs">
          <div className="flex items-center justify-between">
            <Label htmlFor="show-narration" className="font-medium text-black cursor-pointer">
              Show Narrations
            </Label>
            <input
              id="show-narration"
          ...
          <div className="flex items-center justify-between">
            <Label htmlFor="show-percentage" className="font-medium text-black cursor-pointer">
          ...
          <div className="flex items-center justify-between">
            <Label htmlFor="detailed-format" className="font-medium text-black cursor-pointer">
          ...
          <div className="flex items-center justify-between">
            <Label htmlFor="exclude-zero" className="font-medium text-black cursor-pointer">
          ...
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="val-method" className="font-medium text-black">
          ...
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="basis-values" className="font-medium text-black">
              Basis of Values
            </Label>
            <select
              id="basis-values"

    ...
    <div className="flex flex-col min-h-0 flex-1">
      ...
      <div className="flex border-b border-black shrink-0">
        ...
        <div className="flex-1 border-r border-gray-300">
          <div className="text-center text-sm font-semibold py-0.5 border-b border-gray-300">
            Ledger Account
          </div>
          <div className="px-3 py-1 min-h-[56px]">
            ...
            />
            {form.partyBalance && (
              <div className="text-xs text-gray-500 italic px-1 mt-1">
                Current balance : {form.partyBalance}
              </div>
            )}
          </div>
        </div>
            ...
            {form.partyLedger && (
              <>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    form.setPartyDetails({ ...(form.partyDetails ?? {}), address: e.target.value })
                  }
                />
              </>
            )}

...
export default function ContraVoucher({ form }: Props) {
  ...
  const isSingleEntry = form.contraEntryMode === "single";
    ...
    <div className="flex flex-col h-screen bg-white text-black text-sm select-none overflow-hidden animate-fade-in">
      ...
      <div className="flex-1 flex min-h-0 overflow-hidden">
        <div className="flex-1 flex flex-col min-h-0 min-w-0 overflow-hidden border-r border-black">
          {isSingleEntry ? (
            <SingleEntryLayout
              ...
              onParticularFocus={(rowId) => form.handleFieldFocus({ type: "particular", rowId })}
        ...
        <RightSidebar
          ...
          onEntryModeChange={() => form.setContraEntryMode((p: "single" | "double") => p === "single" ? "double" : "single")}

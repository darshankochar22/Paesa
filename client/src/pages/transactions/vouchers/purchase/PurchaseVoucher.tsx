...
export default function PurchaseVoucher({ form }: Props) {
  ...
  const [pendingReceiptDetails, setPendingReceiptDetails] = useState<any>(null);
  ...
  // Open receipt details popup when party ledger is selected for Purchase
  useEffect(() => {
    if (form.partyLedger) setShowReceiptDetails(true);
  }, [form.partyLedger]);
  ...
  useEffect(() => {
    ...
    canAccept, handleAccept, showDatePicker, showReceiptDetails,
    ...
    <div className="flex flex-col h-screen bg-white text-black text-sm select-none overflow-hidden animate-fade-in">
      ...
      {showReceiptDetails && form.partyLedger && (
        <ReceiptDetailsPopup
          ...
          onSave={(details) => {
            setPendingReceiptDetails(details);
      ...
      {showPartyDetails && form.partyLedger && (
        <PartyDetailsPopup
          ...
          onSave={(partyDetails) => {
            ...
            if (pendingReceiptDetails) {
              handleSaveReceiptDetails(pendingReceiptDetails);
              setPendingReceiptDetails(null);
            }
          }}
        />
      )}

  ...
  return (
    <div className="border-b border-gray-300 shrink-0 py-1">
      <div className="flex items-center px-3 py-0 min-h-[22px]">
        ...
        <input
          type="text"
          className="w-64 text-sm border border-gray-400 px-1 py-0 outline-none focus:border-black focus:bg-[#fffbeb] focus:ring-1 focus:ring-amber-500/20 font-bold"

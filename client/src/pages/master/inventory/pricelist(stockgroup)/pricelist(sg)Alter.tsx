...
export default function PriceListSGAlter() {
    ...
    const handler = (e: KeyboardEvent) => {
      if (e.key === "Escape") {
        if (showGroupList || showLevelList || activeItemDropdown !== null) {
          setShowGroupList(false); setShowLevelList(false); setActiveItemDropdown(null); return;
        }
        e.preventDefault();
  ...
  }, [handleSubmit, handleDelete, navigate, showGroupList, showLevelList, activeItemDropdown, step]);

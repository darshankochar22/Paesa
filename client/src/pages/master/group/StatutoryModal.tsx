    ...
    >
      <div className="bg-white border border-zinc-300 shadow-2xl w-[480px] flex flex-col">
        ...
        <div className="px-6 py-5 bg-white">
          {toggles.length === 0 ? (
            <div className="text-sm text-zinc-500 text-center py-4">No applicable tax details</div>
          ) : (
            toggles.map((key) => {
              ...
              return (
                <div key={key} className="flex items-center gap-2 mb-3 last:mb-0">
                  <span className="text-[13px] text-zinc-700 w-60 shrink-0">{meta.label}</span>

...
export default function GSTR2BReconciliation() {
  ...
  const loadData = async () => {
    ...
    try {
      setLoading(true);
      setError(null);
      const result = await window.api.gst.getGSTR2BReconciliation({
    ...
    const handleKey = (e: KeyboardEvent) => {
      if (e.key === 'a' && e.altKey) {
        ...
        navigate('/utilities/copilot', {
          state: {
            initialPrompt:
              'Analyze my GSTR-2B reconciliation status. Please highlight any mismatches and provide GST correction suggestions.',
          },
        });
      }
    };
  ...
  const rows: RowDef[] = [
    ...
    {
      type: 'data',
      label: 'Inward Supplies Liable for Reverse Charge',
      row: itc_avail_rcm,
      indent: 1,
    },
    ...
    {
      type: 'data',
      label: 'Reversal of Available ITC (Purchase Return) - Part B',
      row: itc_avail_reversal,
      indent: 1,
    },
    ...
    {
      type: 'data',
      label: 'Reversal of Unavailable ITC (Purchase Return) - Part B',
      row: itc_unavail_reversal,
      indent: 1,
    },
            ...
            <div className="flex flex-col border-b border-gray-300">
              ...
              <div
                onClick={() =>
                  ...
                  navigate('/master/statutory/gstr2b/reconciliation/uncertain', {
                    state: {
                      registration: null,
                      returnType: 'GSTR2B',
                      reportTitle: 'GSTR-2B Reconciliation',

...
const selectCls =
  'flex-1 bg-transparent text-sm outline-none py-1 px-1 text-zinc-900 cursor-pointer';
      ...
      <div className="flex-1 flex min-h-0">
        ...
        <div className="flex-1 flex flex-col border-r border-zinc-200 overflow-y-auto px-4 py-2">
          ...
          <Row label="Mailing Name">
            <input className={inputCls} value={form.mailing_name} onChange={set('mailing_name')} />
          </Row>

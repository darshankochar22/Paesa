        ...
        <div className="flex-1 flex min-h-0">
          ...
          <div className="flex-1 flex flex-col border-r border-zinc-200 overflow-y-auto px-4 py-2">
            ...
            <div className="flex items-start border-b border-zinc-100 min-h-[28px]">
              ...
              <span className="text-zinc-500 mr-2 py-1 shrink-0">:</span>
              <input className="flex-1 bg-transparent text-sm outline-none py-1 px-1 text-zinc-900" value={form.mailing_name} onChange={set("mailing_name")} />
            </div>
            ...
            <div className="flex items-start border-b border-zinc-100 min-h-[28px]">
              ...
              <div className="flex-1 flex flex-col">
                <input className="flex-1 bg-transparent text-sm outline-none py-1 px-1 text-zinc-900 border-b border-zinc-100" value={form.address1} onChange={set("address1")} />
                <input className="flex-1 bg-transparent text-sm outline-none py-1 px-1 text-zinc-900" value={form.address2} onChange={set("address2")} />
              </div>
            </div>
            ...
            <div className="flex items-start border-b border-zinc-100 min-h-[28px]">
              ...
              <div className="flex items-center flex-1">
                ...
                <select className="flex-1 bg-transparent text-sm outline-none py-1 px-1 text-zinc-900 cursor-pointer" value={form.state} onChange={set("state")}>
            ...
            <div className="flex items-start border-b border-zinc-100 min-h-[28px]">
              ...
              <span className="text-zinc-500 mr-2 py-1 shrink-0">:</span>
              <input className="flex-1 bg-transparent text-sm outline-none py-1 px-1 text-zinc-900" value={form.country} onChange={set("country")} />
            </div>

            <div className="flex items-start border-b border-zinc-100 min-h-[28px]">
              <span className="w-44 text-sm text-zinc-700 shrink-0 py-1 pr-2">Pincode</span>
              <span className="text-zinc-500 mr-2 py-1 shrink-0">:</span>
              <input className="flex-1 bg-transparent text-sm outline-none py-1 px-1 text-zinc-900" value={form.pincode} onChange={set("pincode")} maxLength={6} />
            </div>

            <div className="flex items-start border-b border-zinc-100 min-h-[28px]">
              <span className="w-44 text-sm text-zinc-700 shrink-0 py-1 pr-2">Telephone</span>
              <span className="text-zinc-500 mr-2 py-1 shrink-0">:</span>
              <input className="flex-1 bg-transparent text-sm outline-none py-1 px-1 text-zinc-900" value={form.telephone} onChange={set("telephone")} />
            </div>

            <div className="flex items-start border-b border-zinc-100 min-h-[28px]">
              <span className="w-44 text-sm text-zinc-700 shrink-0 py-1 pr-2">Mobile</span>
              <span className="text-zinc-500 mr-2 py-1 shrink-0">:</span>
              <input className="flex-1 bg-transparent text-sm outline-none py-1 px-1 text-zinc-900" value={form.mobile} onChange={set("mobile")} />
            </div>

            <div className="flex items-start border-b border-zinc-100 min-h-[28px]">
              <span className="w-44 text-sm text-zinc-700 shrink-0 py-1 pr-2">Fax</span>
              <span className="text-zinc-500 mr-2 py-1 shrink-0">:</span>
              <input className="flex-1 bg-transparent text-sm outline-none py-1 px-1 text-zinc-900" value={form.fax} onChange={set("fax")} />
            </div>

            <div className="flex items-start border-b border-zinc-100 min-h-[28px]">
              <span className="w-44 text-sm text-zinc-700 shrink-0 py-1 pr-2">E-mail</span>
              <span className="text-zinc-500 mr-2 py-1 shrink-0">:</span>
              <input className="flex-1 bg-transparent text-sm outline-none py-1 px-1 text-zinc-900" type="email" value={form.email} onChange={set("email")} />
            </div>

            <div className="flex items-start border-b border-zinc-100 min-h-[28px]">
              <span className="w-44 text-sm text-zinc-700 shrink-0 py-1 pr-2">Website</span>
              <span className="text-zinc-500 mr-2 py-1 shrink-0">:</span>
              <input className="flex-1 bg-transparent text-sm outline-none py-1 px-1 text-zinc-900" value={form.website} onChange={set("website")} />
            </div>

            <div className="flex items-start border-b border-zinc-100 min-h-[28px]">
              <span className="w-44 text-sm text-zinc-700 shrink-0 py-1 pr-2">Base Currency symbol</span>
              <span className="text-zinc-500 mr-2 py-1 shrink-0">:</span>
              <select className="flex-1 bg-transparent text-sm outline-none py-1 px-1 text-zinc-900 cursor-pointer" value={form.base_currency_symbol} onChange={set("base_currency_symbol")}>
                <option value="₹">₹</option>
                <option value="$">$</option>
                <option value="€">€</option>
                <option value="£">£</option>
            ...
            <div className="flex items-start border-b border-zinc-100 min-h-[28px]">
              ...
              <span className="text-zinc-500 mr-2 py-1 shrink-0">:</span>
              <input className="flex-1 bg-transparent text-sm outline-none py-1 px-1 text-zinc-900" value={form.formal_name} onChange={set("formal_name")} />
            </div>

            <div className="flex items-start border-b border-zinc-100 min-h-[28px]">
              <span className="w-44 text-sm text-zinc-700 shrink-0 py-1 pr-2">Tally Vault Password</span>
              <span className="text-zinc-500 mr-2 py-1 shrink-0">:</span>
              <input className="flex-1 bg-transparent text-sm outline-none py-1 px-1 text-zinc-900" type="password" value={form.password} onChange={set("password")} />
            </div>
          ...
          <div className="w-64 flex flex-col px-4 py-2 shrink-0">
            ...
            <div className="pl-2 mb-3">
              ...
              >
                {FY_YEARS.map((y) => (
                  <option key={y} value={`${y}-04-01`}>1 Apr {y}</option>
                ))}
              </select>
            </div>
  ...
  return (
    <div className="flex flex-col h-full bg-white select-none">
      ...
      <div className="flex-1 overflow-y-auto">
        {loadingList && (
          <div className="px-4 py-6 text-sm text-zinc-400">Loading companies...</div>
        )}
        {listError && (
          <div className="px-4 py-6 text-sm text-red-500">⚠ {listError}</div>
        )}
        {!loadingList && !listError && companies.length === 0 && (
          <div className="px-4 py-6 text-sm text-zinc-400">No companies found.</div>
        )}
        {!loadingList && !listError && companies.map((c, i) => (
          <button
            key={c.company_id}

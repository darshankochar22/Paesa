...
export default function JobWorkAnalysis() {
  ...
  if (level.step === 'select') {
    return (
      <div className="flex-1 flex flex-col h-full bg-white select-none text-black font-sans text-[11px]">
        ...
        <SelectionPopup
          title="Select Job / Project"
          fieldLabel="Job / Project"
          listLabel="List of Jobs/Projects"
  ...
  return (
    <MovementAnalysisTable
      ...
      companyName={selectedCompany?.name}
      subtitle={`Job/Project: ${level.job.name}`}

  ...
  const sections: Array<{ title: string; items: Array<{ label: string; route: string }> }> = [
    {
      ...
      items: [
        ...
        { label: 'Monthly Statement', route: '/reports/payroll-hr/pf-monthly-statement' },
        {
          ...
          route: '/reports/payroll-hr/pf-e-challan-cum-return-ecr',
        },
      ],
    },
    {
      title: 'ANNUAL',
      items: [
        { label: 'Form 3A', route: '/reports/payroll-hr/pf-form-3a' },
        { label: 'Form 6A', route: '/reports/payroll-hr/pf-form-6a' },
      ],
    },
    {
      title: '',
      items: [{ label: 'E-Return', route: '/reports/payroll-hr/pf-e-return' }],
    },
  ];

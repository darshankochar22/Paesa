    ...
    <Card size="sm" className="w-96 mx-auto mt-10 text-xs">
      <CardHeader className="gap-1 pb-1">
        <div className="text-[11px] italic text-black flex flex-wrap gap-1">
          ...
          <span>&gt;</span>
          <Link to="/reports/statutory/payroll" className="hover:underline hover:text-black">
            Payroll Reports
          </Link>
        </div>
    ...
    <Card size="sm" className="w-96 mx-auto mt-10 text-xs">
      <CardHeader className="gap-1 pb-1">
        <div className="text-[11px] italic text-black flex flex-wrap gap-1">
          ...
          <span>&gt;</span>
          <Link to="/reports/statutory/payroll/pf" className="hover:underline hover:text-black">
            Provident Fund
          </Link>
        </div>

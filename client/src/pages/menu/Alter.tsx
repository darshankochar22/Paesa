...
export default function Alter() {
  ...
  const getRoute = (item: string) => {
    const map: Record<string, string> = {
      ...
      'Price list (Stock Group)': '/master/alter/price-lists-sg',
      'Price list (Stock Category)': '/master/alter/price-lists-sc',
    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-10">
      <div className="w-full max-w-3xl border rounded p-8">
        <div className="flex items-start justify-between mb-12">
          <div className="text-2xl font-semibold">List of Masters (Alter)</div>

...
export const ROUTES = {
  ...
  MASTER_GSTR1_VS_3B: '/master/statutory/gstr1-vs-3b',
  MASTER_GSTR9C: '/master/statutory/gstr9c',

  // Dynamic
  REPORT: (category: string, slug: string) => `/reports/${category}/${slug}`,
  LEDGER_MONTHLY_SUMMARY: (ledgerId: string | number) =>
    `/reports/accounts/ledger-summary/${ledgerId}`,

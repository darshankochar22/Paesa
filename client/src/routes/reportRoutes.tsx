...
import ModifiedVouchers from '../pages/reports/exception/ModifiedVouchers.tsx';
...
export const reportRoutes: RouteConfig[] = [
  ...
  { path: '/reports/statutory/payroll/pf/e-return/form-5', element: <PFForm5 eReturn /> },
  { path: '/reports/statutory/payroll/pf/e-return/form-10', element: <PFForm10 eReturn /> },
  { path: '/reports/statutory/payroll/pf/e-return/form-12a', element: <PFForm12A eReturn /> },
  ...
  { path: '/reports/accounts/group-payment-performance', element: <ReportRunner /> },
  { path: '/reports/accounts/ledger-payment-performance', element: <ReportRunner /> },
  ...
  { path: '/reports/exception/modified-vouchers', element: <ModifiedVouchers /> },

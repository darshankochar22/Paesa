...
contextBridge.exposeInMainWorld('api', {
    ...
    report: {
        ...
        partyOrders:     (company_id, party_ledger_id, voucher_type)             => invoke('report:partyOrders', { company_id, party_ledger_id, voucher_type }),
        partyTrackingNumbers: (company_id, party_ledger_id, voucher_type)        => invoke('report:partyTrackingNumbers', { company_id, party_ledger_id, voucher_type }),
        pendingVoucherItems:  (company_id, voucher_id, mode)                     => invoke('report:pendingVoucherItems', { company_id, voucher_id, mode }),

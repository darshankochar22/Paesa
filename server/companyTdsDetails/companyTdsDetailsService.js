  ...
  try {
    ...
    return {
      ...
      data: {
        ...
        personResponsibleSonOf: record.person_responsible_son_of || '',
        personResponsibleDesignation: record.person_responsible_designation || '',
        personResponsiblePan: record.person_responsible_pan || '',
        personResponsibleFlatNo: record.person_responsible_flat_no || '',
        personResponsiblePremises: record.person_responsible_premises || '',
        personResponsibleRoad: record.person_responsible_road || '',
        personResponsibleArea: record.person_responsible_area || '',
        personResponsibleCity: record.person_responsible_city || '',
        personResponsibleState: record.person_responsible_state || '',
        personResponsiblePincode: record.person_responsible_pincode || '',
        personResponsiblePhone: record.person_responsible_phone || '',
        personResponsibleStdCode: record.person_responsible_std_code || '',
        personResponsibleTelephone: record.person_responsible_telephone || '',
    ...
    if (existing && existing.length > 0) {
      ...
      await db
        ...
        .set({
          ...
          personResponsibleSonOf: data.personResponsibleSonOf || null,

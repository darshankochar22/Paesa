...
const INSERT_GROUP_SQL = `
  INSERT INTO groups (
    ...
    set_alter_tcs_details, set_alter_other_statutory_details,
    hsn_sac_source, hsn_sac_description, gst_rate_source, taxability_type,
    ...
    try {
      ...
      const result = await db.execute({
        ...
        args: {
          ...
          set_alter_other_statutory_details: data.set_alter_other_statutory_details ? 1 : 0,
          hsn_sac_source: data.hsn_sac_source || null,
          hsn_sac_description: data.hsn_sac_description || null,
          gst_rate_source: data.gst_rate_source || null,
          taxability_type: data.taxability_type || null,
      ...
      await db.execute({
        sql: `
          UPDATE groups SET
            ...
            set_alter_other_statutory_details = :set_alter_other_statutory_details,
            hsn_sac_source = :hsn_sac_source,
        ...
        args: {
          ...
          set_alter_tcs_details: data.set_alter_tcs_details ? 1 : 0,
          set_alter_other_statutory_details: data.set_alter_other_statutory_details ? 1 : 0,
          hsn_sac_source: data.hsn_sac_source !== undefined ? data.hsn_sac_source : group.hsn_sac_source,
          hsn_sac_description: data.hsn_sac_description !== undefined ? data.hsn_sac_description : group.hsn_sac_description,
          gst_rate_source: data.gst_rate_source !== undefined ? data.gst_rate_source : group.gst_rate_source,
          taxability_type: data.taxability_type !== undefined ? data.taxability_type : group.taxability_type,
          behaves_like_subledger: data.behaves_like_subledger ? 1 : 0,
          show_net_debit_credit: data.show_net_debit_credit ? 1 : 0,
          used_for_calculation: data.used_for_calculation ? 1 : 0,

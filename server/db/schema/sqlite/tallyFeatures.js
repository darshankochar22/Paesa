...
const tallyFeatures = sqliteTable('tally_features', {
  ...
  useDebitCreditNotes: integer('use_debit_credit_notes').default(1),
  useTrackingNumbers: integer('use_tracking_numbers').default(1),
  useRejectionNotes: integer('use_rejection_notes').default(1),

const { pgTable, bigint, text, numeric, integer, boolean, jsonb, timestamp } = require('drizzle-orm/pg-core');
...
const companyGstDetails = pgTable('company_gst_details', {
  ...
  interstateThresholdLimit: numeric('interstate_threshold_limit', { precision: 18, scale: 2 }).default('50000'),
  intrastateThresholdLimit: numeric('intrastate_threshold_limit', { precision: 18, scale: 2 }).default('50000'),

...
// Modified Voucher Register — Gateway → Display More Reports → Exception Reports
// → Modified Vouchers (shown only when F11 "Mark modified vouchers" is on). Lists
// every voucher altered after original entry (is_modified = 1). Same shape/columns
// as the Marked Voucher Register so it renders identically and drills to the voucher.
module.exports = {
